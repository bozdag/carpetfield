...
public class OrganizationController {
  ...
  public Collection<User> getOrganizationGamePlayersByGameId(@PathVariable Long id,
  ...
  public User getOrganizationGamePlayerByPlayerId(@PathVariable Long id, @PathVariable Long game_id,
  ...
  public Collection<Team> getOrganizationGameTeamsByGameId(@PathVariable Long id,
      @PathVariable Long game_id) {
  ...
  public Team getOrganizationGameTeamByTeamId(@PathVariable Long id, @PathVariable Long game_id,
  ...
  public Collection<User> getOrganizationGameTeamPlayersByTeamId(@PathVariable Long id,
      @PathVariable Long game_id, @PathVariable Long team_id) {
